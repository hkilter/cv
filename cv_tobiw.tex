...
\begin{languagecontent}{german}
   ...
   \setprojectvar{dekonstruiert}{content}{
      ...
      Illustrator und InDesign gemacht.
   ...
   \setprojectvar{master}{content}{
      ...
      Ende einer offenen Röhre“. Die Arbeit habe ich mit \XeTeX/ gesetzt und \TikZ/
   ...
   \setprojectvar{musicaincantans}{content}{
      ...
      gegenüberliegenden Seiten im Original und deutscher Übersetzung gedruckt.
   ...
   \setprojectvar{nve}{content}{
      ...
      projektweise arbeitender Kammerchor, der anspruchsvolle Chormusik von
      Renaissance bis Moderne erarbeitet und aufführt. Ich habe für den Chor ein
      Corporate Design entwickelt und umgesetzt.
   ...
   \setprojectvar{speight}{content}{
      ...
      erhältlichen Noten von \emph{Sam’s Mass} eine leichter lesbare gedruckte
      Version angefertigt, wobei ich zusätzliche Symbolen entwickelt habe, um den
