...
\begin{languagecontent}{german}
   \setvar{main}{%
      ...
      Ich stehe Ihnen gerne zur Verfügung, um mit Ihnen gemeinsam eine Erscheinungsbild
      (\emph{Corporate Identity}) zu entwickeln, für Ihre Texte oder Noten in ein
   ...
   \setvar{timeline-entries}{
      ...
      \timelineentry{2007-2008}[12]{Freiwilliges Soziales Jahr Kultur}
         {Während meines FSJ beim Landesmusikrat Niedersachsen e.\,V.
         habe ich diverse Projekte wie \emph{Jugend musiziert} mitorganisiert.}[11]
      ...
      \timelineentry{2012}[2]{Bachelorarbeit}
         {„Entwicklung des Java-Programms FIELDS zur zweidimensionalen\linebreak
         Darstellung von Feldern mithilfe des PhidgetInterfaceKit 2/2/2“}[9]
      ...
      \timelineentry{2013}[17]{wissenschaftliche Hilfskraft}
